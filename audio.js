const audioPuzzlesData = [
    { word: "Wednesday", audio: "./Audio/wednesday.mp3" },
    { word: "Monday", audio: "./Audio/monday.mp3" },
    { word: "Tuesday", audio: "./Audio/tuesday.mp3" },
    { word: "Thursday", audio: "./Audio/thursday.mp3" },
    { word: "Friday", audio: "./Audio/friday.mp3" },
    { word: "Saturday", audio: "./Audio/saturday.mp3" },
    { word: "Sunday", audio: "./Audio/sunday.mp3" }
];
